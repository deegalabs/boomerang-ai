...
TR: dict[str, dict[str, str]] = {
    "en": {
        ...
        "fnd_identity_d": "A kinetic boomerang — capital thrown to the market and returned to its owner. Sharp BNB gold over deep space.",
        "fnd_type": "Typography",
        "fnd_color": "Color",
        ...
        "l_s3_body": "Signs and sends the transaction with the agent's own key. It never touches the browser or the site. Real self-custody.",
        ...
        "l_sec1_t": "Self-custody", "l_sec1_d": "The private key belongs to the agent and never reaches the browser or the site.",
        ...
        "track_title": "Verified on-chain track record",
        "track_sub": "The full lifecycle — every transaction is real and clickable on the explorer.",
    ...
    "pt": {
        ...
        "fnd_identity_d": "Um boomerang cinético — o capital lançado ao mercado e devolvido ao dono. Dourado da BNB afiado sobre o espaço profundo.",
        "fnd_type": "Tipografia",
        "fnd_color": "Cor",
        ...
        "l_s3_body": "Assina e envia a transação com a chave do próprio agente. Ela nunca toca o navegador nem o site. Autocustódia de verdade.",
        ...
        "l_sec1_t": "Autocustódia", "l_sec1_d": "A chave privada é do agente e nunca vai pro navegador nem pro site.",
        ...
        "track_title": "Histórico on-chain verificado",
        "track_sub": "O ciclo completo — toda transação é real e clicável no explorador.",
